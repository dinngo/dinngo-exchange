...
contract SerializableWithdrawal is Withdrawal, Seriality {
     ...
     * @param ser_data Serialized withdrawal data
     * @return fMain Is the fee paid in ETH or DGO
     */
    function isWithdrawalETH(bytes ser_data) public pure returns (bool fMain) {
        fMain = (bytesToUint8(withdrawal_size - 38, ser_data) & MASK_IS_ETH != 0);
    }
