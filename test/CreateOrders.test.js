...
function getHex(userID, tokenIDBase, amountBase, tokenIDQuote, amountQuote, config, handleFee, gasFee, nonce) {
    const userID_h = utils.padLeft(utils.toHex(userID), 8);
    const tokenIDBase_h = utils.padLeft(utils.toHex(tokenIDBase), 4);
    const amountBase_h = utils.padLeft(utils.toHex(amountBase), 64);
    const tokenIDQuote_h = utils.padLeft(utils.toHex(tokenIDQuote), 4);
...
contract('SerializableOrder for buying taker', function ([_, user1, user2, user3, user4, user5]) {
    const user1ID = 11;
...
/*
    ...
    describe('multiple orders', async function () {
        it('hex_1_2_3_4_5', async function () {
            ...
            console.log(sgn1 + sgn2.slice(2));
            console.log("1+2+3");
            console.log(ser_hex1 + ser_hex2.slice(2) + ser_hex3.slice(2));
            console.log(sgn1 + sgn2.slice(2) + sgn3.slice(2));
            console.log("1+2+3+4");
            console.log(ser_hex1 + ser_hex2.slice(2) + ser_hex3.slice(2) + ser_hex4.slice(2));
            console.log(sgn1 + sgn2.slice(2) + sgn3.slice(2) + sgn4.slice(2));
...
/*
    describe('multiple orders', async function () {
        it('hex_1_2_3_4_5', async function () {
            ...
            console.log(sgn1 + sgn2.slice(2));
            console.log("1_3");
            console.log(ser_hex1 + ser_hex3.slice(2));
            console.log(sgn1 + sgn3.slice(2));
            console.log("1_4");
            console.log(ser_hex1 + ser_hex4.slice(2));
